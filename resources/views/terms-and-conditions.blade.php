        ...
        <main>
            <section class="container py-5 my-5">
                ...
                <p class="text-lg-start fw-bold text-gradient mx-5 mb-5">
                    Esta política de Termos de Uso é válida a partir de Sep 2022.
                </p>
                ...
                <ul>
                    <li>
                        <h4 class="fw-bold text-gradient-dark pt-5 pb-2">
                            Seção 1 - Usuário
                        </h4>
